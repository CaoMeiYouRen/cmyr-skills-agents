...
- [ ] Step 4: 应用依赖升级
  ...
  - [ ] 4.3 若遇到 pnpm install --frozen-lockfile 失败，运行 <skill-dir>/scripts/repair-frozen-lockfile.mjs 修复并验证 lockfile 一致性。
...
- <skill-dir>/scripts/repair-frozen-lockfile.mjs：自动修复 pnpm install --frozen-lockfile 失败导致的锁文件不同步问题。
